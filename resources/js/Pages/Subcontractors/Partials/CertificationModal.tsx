...
export default function CertificationModal({
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        form.post(route('subcontractors.certifications.store', partnerId), {
            preserveScroll: true,
            forceFormData: true,
            onSuccess: onClose,
        });
            ...
            <div className="fixed inset-0 flex items-center justify-center overflow-y-auto p-4">
                <DialogPanel className="o-card w-full max-w-lg p-6">
                    <DialogTitle className="text-lg font-semibold text-sidebar">
                        Dokumentum / tanúsítvány felvétele
                    </DialogTitle>
                    ...
                    <form onSubmit={submit} className="mt-4 space-y-4">
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            <div>
                                ...
                                >
                                    {Object.entries(certTypes).map(([value, label]) => (
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                placeholder="pl. Felelősségbiztosítási kötvény"
                                isFocused
                                autoComplete="off"
                            />
